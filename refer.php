...
else printf("<tr>\n<td>\n<a href=\"?path=".dirname($directory)."/\">\n<div class=\"item\" id=\"".$i."\" onmouseout=\"hover(0, '".$i."', '".$directory.$index[$i]."', '')\" onmouseover=\"hover(1, '".$i."', '".dirname($directory)."/', '')\">\n<p align=\"center\"><img height=\"50px\" src=\"images/file-symlink-directory.svg\"></img></p>\n<p align=\"center\">[Parent]</p>\n</div>\n</a>\n</td>\n<td>\n</td>\n<td>\n</td>\n<td>\n</td>\n</tr>\n");
